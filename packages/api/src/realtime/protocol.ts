...
// route in routes/data.ts negotiates the subprotocol, and the injected SDK in postplandb/client.ts
...
export const WS_PROTOCOL = 'postplan.db.v1'
...
export const TOKEN_HEADER = 'x-postplan-data-token'
