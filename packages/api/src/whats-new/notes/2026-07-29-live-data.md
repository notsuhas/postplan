...
featured: false
---
A page you deploy can now **store data and update itself** — no backend to run, nothing to host. Ask for a form, a poll, a board or a dashboard, and it gets a real data store: `postplan.db`.
